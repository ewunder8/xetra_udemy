...
class S3BucketConnector():
    """
    Class for insteracting with S3 bucket
    """
    def __init__(self, access_key: str, secret_key: str, endpoint_url: str, bucket: str):
        """
        Constructor for S3BucketConnector

        :param access_key: access key for access S3
        :param secret_key: secret key for access S3
        :param endpoint_url: URL to S3 bucket
        ...
        # underline makes it protected variable, dont touch
    ...
    def __put_object(self, out_buffer: StringIO or BytesIO, key: str): 
        # this was redundant code in the notebook
        """
