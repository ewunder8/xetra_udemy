...
class TestMetaProcessMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_meta = 'test-bucket'
        ...
        self.s3.create_bucket(Bucket=self.s3_bucket_meta,
                            CreateBucketConfiguration={
                                'LocationConstraint': 'eu-central-1'
                            })
        self.s3_bucket = self.s3.Bucket(self.s3_bucket_meta)
    ...
    def test_update_meta_file_empty_date_list(self):
        ...
        with self.assertLogs() as logm:
            ...
            # Log test after method exeuction
