...
class IntTestXetraETLMethods(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.s3_bucket_name_src = 'xetra-inttest-src'
        self.s3_bucket_name_trg = 'xetra-inttest-trg'
        ...
        data_report = [['AT0000A0E9W5', self.dates[3], 20.21, 18.27, 18.21, 21.34, 1088, 10.62],
                       ['AT0000A0E9W5', self.dates[2], 20.58,
    ...
    def test_int_etl_report1_no_metafile(self):
        ...
        trg_file = self.s3_bucket_trg.list_files_in_prefix(
