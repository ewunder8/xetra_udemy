...
class TestS3BucketConnectorMethods(unittest.TestCase):
    """
    Testing the S3BucketConnector clas
    """
    def setUp(self):
        """
        Setting up the enviornment
        """
        # mocking s3 connect start
    ...
    def test_read_csv_to_df_ok(self):
        """
        Tests the read_csv_to_df_method for reading 1 .csv file 
        from the mocked s3 bucket
        """
        # Expected results
        key_exp = 'test.csv'
        col1_exp = 'col1'
    ...
    def test_write_df_to_s3_empty(self):
        """
        Tests the write_df_to_s3_empty method with
        ...
        with self.assertLogs() as logm:
            ...
            self.assertIn(log_exp, logm.output[0])
        # Test after metho execution
        self.assertEqual(return_exp, result)

    def test_write_df_to_s3_csv(self):
        """
        Test wthe write_df_to_s3 method
        """
        # Expected resutls
        return_exp = True
